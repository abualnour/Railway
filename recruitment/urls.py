...
from .views import (
    ...
    CandidateInterviewFeedbackView,
    CandidateInterviewUpdateView,
    CandidateListView,
    CandidateOfferDecisionView,
    CandidateUpdateView,
...
urlpatterns = [
    ...
    path("kanban/", RecruitmentKanbanView.as_view(), name="kanban"),
    ...
    path("candidates/<int:pk>/offer-decision/", CandidateOfferDecisionView.as_view(), name="candidate_offer_decision"),
    ...
    path("interviews/<int:pk>/feedback/", CandidateInterviewFeedbackView.as_view(), name="candidate_interview_feedback"),
